 ...
 <form action="saveledger.php" method="post" class = "form-group">
 	...
 	<div id="ac">
 		<span>จำนวนเงิน : </span><input type="text" name="amount" class = "form-control" />
 		<span>สถาณะ : </span><input type="text" name="remarks" class = "form-control" />
 		<span>&nbsp;</span><input class="btn btn-primary btn-block"  type="submit" value="บันทึก" class = "form-control" />
 	</div>
 </form>