    					...
    					<div class="content" id="content">
    						<div>
    							...
    							for($i=0; $rowaz = $resultaz->fetch(); $i++){
    								echo 'Transaction ID : JSH-'.$rowaz['transaction_id'].'<br>';
    						...
    						<table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
    							...
    							<tbody>
    								...
    								for($i=0; $row = $result->fetch(); $i++){
    									...
    									?>
    									<tr>
    										<td colspan="2"><strong style="font-size: 12px; color: #222222;">รวม:</strong></td>
    							...
    							<a id="cccc" class="btn btn-primary" href="purchaseslist.php" style="margin-right: 10px;">ย้อนกลับ</a>
    							<a href="" onclick="window.print()" class="btn btn-info"><i class="icon-print icon-large"></i> ปริ้น</a>
