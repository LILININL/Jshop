	...
	<div style="margin: 0 auto; padding: 20px; width: 700px; font-weight: normal;">
		<div style="width: 100%;">
			<div style="width: 459px;">
				<p>J Shop <br />
					Address: 195 หมู่ 4 โรงเรียนอนุบาลจำเนียรวิทยา<br />
					ติดต่อ No: 054-427252<br>
					Email Add : ldaepoo1@gmail.com<br></p>
					<div>
						<?php
				...
				<table border="1" cellpadding="4" cellspacing="0" style="font-family: arial; font-size: 15px;text-align:left;" width="100%">
					...
					<tbody>
						...
						<?php if($pt=='cash'){
							?>
							<tr>
								<td colspan="6"><strong style="font-size: 12px; color: #222222;">รับเงินสด:</strong></td>
								<td colspan="2"><strong style="font-size: 12px; color: #222222;">
									<?php
							...
							<tr>
								<td colspan="6"><strong style="font-size: 12px; color: #222222;">จำนวนเงินทั้งหมด:</strong></td>
								<td colspan="2"><strong style="font-size: 12px; color: #222222;">
									<?php
									$sdsd=$_GET['id'];
			...
			<div style="text-align: right; margin-top: 13px;">คนขาย : <?php echo $cashier ?></div>
		</div>
	</div>
