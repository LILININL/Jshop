    ...
    c.GaugeAxis = c.Class({
        ...
        draw: function () {
            ...
            var z = {
                ...
                t, F;
            this.gridInside ? F = t = y : (t = y - h, F = t + H);
            var n = this.bands;
            if (n)
                for (var r = 0; r < n.length; r++) {
                    ...
                    if (p) {
                        var x = p.startValue,
                            B = p.endValue,
                            l = c.toCoordinate(p.radius, y);
                        isNaN(l) && (l = F);
                        var w = c.toCoordinate(p.innerRadius, y);
                        isNaN(w) && (w = l - H);
                        var J = u + f * (x - this.startValue),
                            B = f * (B - x),
                            A = p.outlineColor;
                        void 0 == A && (A = this.bandOutlineColor);
                        var K = p.outlineThickness;
                        ...
                        p.url && (A.cursor = "pointer");
                        l = c.wedge(q, C, D, J, B, l, l, w, 0, A);
                        c.setCN(a, l.wedge, "axis-band");
                        void 0 !== p.id && c.setCN(a, l.wedge, "axis-band-" + p.id);
                        l.setAttr("opacity", x);
                        this.set.push(l);
                        this.addEventListeners(l, p)
                    }
                }
            f = this.axisThickness / 2;
            k = c.wedge(q, C, D, u, k - u, t + f, t + f, t - f, 0, z);
            ...
            f = c.getDecimals(g);
            for (z = 0; z < d; z++)
                if (n = e + z * g, t = u + z * v, r = k(C + y * Math.sin(t / 180 * Math.PI)), p = k(D - y * Math.cos(t / 180 * Math.PI)), l = k(C + (y - h) * Math.sin(t / 180 * Math.PI)), w = k(D - (y - h) * Math.cos(t / 180 * Math.PI)), r = c.line(q, [r, l], [p, w], G, E, M, 0, !1, !1, !0), c.setCN(a, r, "axis-tick"), b.push(r), r = -1, l = this.labelOffset, this.inside || (l = -l - h, r = 1), p = C + (y - h - l) * Math.sin(t / 180 * Math.PI), l = D - (y - h - l) * Math.cos(t / 180 * Math.PI), x = this.fontSize, isNaN(x) && (x = a.fontSize), w = Math.sin((t - 90) / 180 * Math.PI), J = Math.cos((t - 90) / 180 *
                        Math.PI), 0 < I && this.labelsEnabled && z / I == Math.round(z / I) && (this.showLastLabel || z != d - 1) && (this.showFirstLabel || 0 !== z) && (B = this.usePrefixes ? c.addPrefix(n, a.prefixesOfBigNumbers, a.prefixesOfSmallNumbers, a.nf, !0) : c.formatNumber(n, a.nf, f), (A = this.unit) && (B = "left" == this.unitPosition ? A + B : B + A), (A = this.labelFunction) && (B = A(n)), n = this.color, void 0 == n && (n = a.color), n = c.text(q, B, n, a.fontFamily, x), c.setCN(a, n, "axis-label"), x = n.getBBox(), n.translate(p + r * x.width / 2 * J, l + r * x.height / 2 * w), b.push(n)), z < d - 1)
                    for (n = 1; n < m; n++) w =
                        t + N * n, r = k(C + F * Math.sin(w / 180 * Math.PI)), p = k(D - F * Math.cos(w / 180 * Math.PI)), l = k(C + (F - H) * Math.sin(w / 180 * Math.PI)), w = k(D - (F - H) * Math.cos(w / 180 * Math.PI)), r = c.line(q, [r, l], [p, w], G, E, M, 0, !1, !1, !0), c.setCN(a, r, "axis-tick-minor"), b.push(r);
            this.axisCreated = !0;
        ...
        drawArrow: function (a, b) {
            ...
            if (!a.hidden) {
                var d = a.axis,
                    ...
                    f = c.toCoordinate(a.radius, d.radiusReal);
                d.inside || (f -= 15);
                var q = a.nailColor;
                q || (q = a.color);
                var G = a.nailColor;
                G || (G = a.color);
                0 < a.nailRadius && (q = c.circle(e, a.nailRadius, q, a.nailAlpha, a.nailBorderThickness, q, a.nailBorderAlpha), c.setCN(this, q, "gauge-arrow-nail"), a.set.push(q), q.translate(m, u));
                isNaN(f) && (f = g - d.tickLength);
                var d = Math.sin(b / 180 * Math.PI),
                    g = Math.cos(b / 180 * Math.PI),
                    q = Math.sin((b + 90) / 180 * Math.PI),
                    E = Math.cos((b + 90) / 180 * Math.PI),
                    e = c.polygon(e, [m - k / 2 *
                        q + v * d, m + f * d - h / 2 * q, m + f * d + h / 2 * q, m + k / 2 * q + v * d
                    ], [u + k / 2 * E - v * g, u - f * g + h / 2 * E, u - f * g - h / 2 * E, u - k / 2 * E - v * g], a.color, a.alpha, 1, G, a.borderAlpha, void 0, !0);
        ...
        updateAnimations: function () {
            ...
            for (var a = this.arrows.length, b, e = 0; e < a; e++)
                if (b = this.arrows[e], b.axis && b.axis.value2angle) {
                    var d;
                    b.frame >= this.totalFrames ? d = b.value : (b.frame++, b.clockWiseOnly && b.value < b.previousValue && (d = b.axis, b.previousValue -= d.endValue - d.startValue), d = c.getEffect(this.startEffect), d = c[d](0, b.frame,
                        b.previousValue, b.value - b.previousValue, this.totalFrames), isNaN(d) && (d = b.value));
                    d = b.axis.value2angle(d);
                    b.drawnAngle != d && (this.drawArrow(b, d), b.drawnAngle = d)
                }
        }
    })
})();