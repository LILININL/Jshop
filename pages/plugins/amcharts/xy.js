    ...
    e.AmRectangularChart = e.Class({
        ...
        drawZoomOutButton: function () {
            ...
            if (!a.zbSet) {
                ...
                var r = l = 0;
                void 0 !== a.pathToImages && h && (q = a.container.image(a.pathToImages + h + a.extension, 0, 0, g, g), e.setCN(a, q, "zoom-out-image"), b.push(q), q = q.getBBox(), l = q.width + 5);
        ...
        drawPlotArea: function () {
            ...
            f.translate(c + a, d + b);
            this.set.push(f);
            0 !== a && 0 !== b && (f = this.plotAreaFillColors, "object" == typeof f && (f = f[0]), f = e.adjustLuminosity(f, -.15), g = e.polygon(this.container, [0, a, g + a, g, 0], [0, b, b, 0, 0], f, k, 1, m, l), e.setCN(this, g, "plot-area-bottom"), g.translate(c, d + h), this.set.push(g), a = e.polygon(this.container, [0,
                0, a, a, 0
            ], [0, h, h + b, b, 0], f, k, 1, m, l), e.setCN(this, a, "plot-area-left"), a.translate(c, d), this.set.push(a));
    ...
    e.AmXYChart = e.Class({
        ...
        drawChart: function () {
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                this.zoomScrollbar();
                if (!this.autoMargins || this.marginsUpdated) this.dispDUpd(), this.chartCreated = !0
            }
        },
        cleanChart: function () {
