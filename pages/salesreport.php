...
<div class="container-scroller">
    ...
    <div id="page-wrapper">
        <div class="container" style="margin-left:15px;">
            <div class="row">
                <div class="col-lg-12">
                    <h1 class="page-header">รายงานการขาย</h1>
                </div>
                    <div class="table-responsive-xl">
                <div id="maintable" class="table-responsive-xl" ><p>
                <div class="input-group-prepend"> 
                    ...
                    <table width="100%"  class="table table-responsive table-hover text-light " id="Tablesdata">
                        <thead >
                            <tr>
                                <th scope="col" style="color:white"> รหัสใบเสร็จ </th>
                                <th scope="col" style="color:white"> วันที่ </th>
                                <th  width="250px" scope="col" style="color:white"> ชื่อสินค้า </th>
                                <th scope="col" style="color:white"> จำนวน </th>
                                <th scope="col" style="color:white"> ยอดขายทั้งหมด </th>
                        ...
                        <tbody class="table-responsive-xl" >
                            ...
                            <?php
                            include('connect.php');
                            $result = $db->prepare("SELECT * FROM sales as A INNER JOIN sales_order as B ON A.invoice_number = B.invoice  
                            ORDER BY A.`date` ASC");
                            $result->execute();
                            ...
                            <tr class="record">
                                ...
                                <!-- <td>
                                    <a href="#" id="<?php echo $row['transaction_id']; ?>"
                                        class="btn btn-danger delbutton" title="Click To Delete">
                                        <span ><i class="mdi mdi-delete btn-icon-append"> ลบ</i></span>
                                    </a>
                                    &nbsp;
                        ...
                        <thead>
                            <tr>
                                <th colspan="4" style="border-top:2px solid #FFFFFF" ><font color="#FFFFFF"> จำนวนเงินทั้งหมด </font></th>
                                <th colspan="0" style="border-top:2px solid #FFFFFF"><font color="#FFFFFF">
                                    <?php
                                    include('connect.php');
...
<script>
  ...
  if (password.length == 0) {
    ...
    function html_table_to_excel(type)
    {
        ...
        XLSX.writeFile(file, 'รายงานการขาย.' + type);
    }
