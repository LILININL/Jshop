...
<body>
 ...
 <div id="page-wrapper">
    <div class="container-fluid">
        <div class="row">
            <div class="col-lg-12">
                <h1 class="page-header">แบบฟอร์มใบสั่งซื้อ</h1>
            </div>
            ...
            <form action="savepurchase.php" method="post" class = "form-group" name="purchase_order">
                ...
                $today = date('Y-m-d');
                ?>
                <label>วันที่ : </label><input type="text" class = "form-control" name="date" value = "<?php echo $today; ?>" />

                <label>รหัสใบเสร็จ : </label><input type="text" class = "form-control" name="invoice" value = "<?php echo $code; ?>" />

                <label>Supplier : </label><input type = "text" class = "form-control" name = "supplier" value = "<?php echo $_GET['name']; ?>">

                <label>วันที่ส่งมอบ : </label><input type="date" class = "form-control" name="date_delivered" />
            ...
            <button class="btn btn-primary" type="submit">ปริ้น</button>
        </form>
    </div>
    <!-- /.container-fluid -->
</div>
