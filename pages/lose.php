      ...
      <body>
        ...
        <div id="page-wrapper">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-12">
                <h1 class="page-header">กราฟสินค้าหมดอายุ</h1>
              </div>
            </div>
            ...
            <div class="content" id="content">
              <p> กราฟสินค้าหมดอายุตามหมวดหมู่</p>
              <div class="row">
                <?php 
                include('connect.php');
                   ...
                   <table width="100%" class="table table-striped table-bordered table-hover" id="dataTables-example">
                    ...
                    <thead>
                      <tr>
                        ...
                        <th> ประเภท</th>
                        <th> จำนวนเงินทั้งหมดที่ขาดทุน</th>
                        <th> จำนวนรวมที่สูญเสีย</th>
                        <th> ค่าใช้จ่าย</th>
          ...
          <a href="javascript:Clickheretoprint()" style="font-size:15px"; class="btn btn-primary"><i class="fa fa-print"></i>ปริ้น</a>
        </div>
        <!-- /.container-fluid -->
      </div>
      <!-- /#page-wrapper -->
