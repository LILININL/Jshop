...
<body>
 ...
 <div id="page-wrapper">
  <div class="container-fluid">
    <div class="row">
      <div class="col-lg-12">
        <h1 class="page-header"><?php echo $_GET['name'];  ?> แบบฟอร์มใบสั่งซื้อ  </h1>
      </div>
      ...
      <form action="savepurchase.php" method="post" class = "form-group">
        ...
        $today = date('Y-m-d');
        ?>
        <label>วันที่ : </label><input type="text"  style="width: 600px;" class = "form-control" name="date" value = "<?php echo $today; ?>" />

        <label>Supplier : </label><input type = "text" style="width: 600px;" class = "form-control" name = "supplier" value = "<?php echo $_GET['name']; ?>">

        <label>วันที่ส่งมอบ : </label><input type="date" style="width: 600px;" class = "form-control" name="date_delivered" />
